...
usage: main.py [-h] [-w WEIGHTS] [-o OUTPUT] [-a] [-dt] [-ic] [-i] [-tr4] [-p PRINT_SPOTS] [-g GANTRY_ANGLES]
               [-d DUPLICATE_FIELDS] [-rd RESCALE_DOSE] [-rf RESCALE_FACTOR] [-tp TABLE_POSITION] [-sp SNOUT_POSITION]
               [-tm TREATMENT_MACHINE] [-pl PLAN_LABEL] [-pn PATIENT_NAME] [-rn REVIEWER_NAME] [-v]
               inputfile
...
options:
  ...
  -p PRINT_SPOTS, --print_spots PRINT_SPOTS
                        Number of random values to print for comparison
  ...
  -tp TABLE_POSITION, --table_position TABLE_POSITION
                        New table position vertical,longitudinal,lateral [cm]. Negative values should be in quotes and
                        leading space.
